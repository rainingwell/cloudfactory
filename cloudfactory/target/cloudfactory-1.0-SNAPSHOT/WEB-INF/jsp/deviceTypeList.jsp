...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            method: 'post',
            url: '${pageContext.request.contextPath}/deviceType/typelist',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'typename', width: 180, title: '设备类别'},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '../statics/page/deviceType/add.html',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '../statics/page/deviceType/edit.html',
                ...
                layer.confirm('真的删除行么', function (index) {
                    $.ajax({
                        type:"GET",
                        url:'${pageContext.request.contextPath}/deviceType/deleteDeviceType',
                        data:{id: obj.data.id},
                        dataType:"text",
