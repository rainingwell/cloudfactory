...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="${pageContext.request.contextPath }/user/do_login">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="../statics/images/captcha.jpg">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <blockquote class="layui-elem-quote layui-text">
                    <a href="${pageContext.request.contextPath}/statics/page/table/add.html" target="_blank">注册点这里</a>
                </blockquote>
            </form>
        </div>
    </div>
...
<script>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(login)', function (data) {
            ...
            layer.msg('正在登录',msg);//显示不出来，但必须写了才能登陆
            // layer.msg('正在登录', function () {
                // window.location = '/statics/index.html';
            // });
            return false;
        });
    });
