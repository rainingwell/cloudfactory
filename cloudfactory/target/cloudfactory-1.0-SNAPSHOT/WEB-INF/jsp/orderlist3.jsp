...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-xs" lay-event="toubiao">投标</a>
        </script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            method: 'post',
            url: '${pageContext.request.contextPath}/order/list3',
            toolbar: '#toolbarDemo',
            ...
            var data = obj.data;
             if (obj.event === 'toubiao') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '../statics/page/order/cloudbid.html',
